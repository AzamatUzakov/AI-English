...
let AIService = AIService_1 = class AIService {
    ...
    constructor(configService) {
        ...
        const apiKey = this.configService.get('ANTHROPIC_API_KEY') || this.configService.get('CLAUDE_API_KEY');
    ...
    async generateResponse(currentTopic, history, pastSummaries) {
    ...
    async generateLessonSummary(topic, history) {
        if (this.useMock || !this.anthropic) {
...
`;
    ...
    buildSystemPrompt(currentTopic, pastSummaries) {
...
`;
    ...
    async generateMockResponse(topic, history) {
